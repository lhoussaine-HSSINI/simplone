...
<%@ page import="MVC.Model.FormateurEntity" %>
<%@ page import="java.util.List" %>
<%@ page import="MVC.Model.ApprenanteEntity" %>
<%@ page import="MVC.Model.PromotionEntity" %>
<%--
...
<div class="table-responsive">
    ...
    <%
        ...
        List<FormateurEntity> list_formateur = admin_operation.getAllformatuer();
        for(FormateurEntity f : list_formateur) {
    %>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <%
                                        ...
                                        List<PromotionEntity> list_promotion = admin_operation_p.getAllpromotion();
                                        System.out.println(list_promotion);
                                        for(PromotionEntity p : list_promotion) {
                                    %>
                                    <tr scope="row">
                                        <td><%=p.getIdPromo()%></td>
                                        <td><%=p.getYear()%></td>
