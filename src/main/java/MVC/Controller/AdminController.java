...
public class AdminController extends HttpServlet {
    ...
    private FormateurEntity user_formateur;
    private ApprenanteEntity user_apprenante;
...
//                                     neme Operation : add edit delete   ====> path_name_action
        ...
        switch (path_name_action){
            case "add_formateur":
                ...
                user_formateur= new FormateurEntity(nom,prenom,username,password);
            ...
            case "edit_formateur":
                ...
                username = request.getParameter("username");
                password = request.getParameter("password");
                user_formateur= new FormateurEntity(id_formateur,nom,prenom,username,password);
            ...
            case "add_apprenante":
                ...
                username = request.getParameter("username");
                password = request.getParameter("password");
                user_apprenante= new ApprenanteEntity(nom,prenom,username,password);
            ...
            case "edit_apprenante":
                ...
                username = request.getParameter("username");
                password = request.getParameter("password");
                user_apprenante= new ApprenanteEntity(id_apprenante,nom,prenom,username,password);
            ...
            case "add_promotion":
                ...
                promotion= new PromotionEntity(year);
            ...
            case "edit_promotion":
                ...
                year = request.getParameter("year");
                promotion= new PromotionEntity(id_promotion,year);
